...
namespace gazebo
{
GZ_REGISTER_WORLD_PLUGIN(Vehicle_w)
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void Vehicle_w::Load(physics::WorldPtr _parent, sdf::ElementPtr _sdf)
{
  // save pointers
  this->world = _parent;
  this->sdf = _sdf;
  ...
  this->deferredLoadThread = boost::thread(
    boost::bind(&Vehicle_w::DeferredLoad, this));
}

////////////////////////////////////////////////////////////////////////////////
// Load the controller
void Vehicle_w::DeferredLoad()
{
  // initialize ros
  ...
  this->callbackQueueThread = boost::thread(
    boost::bind(&Vehicle_w::ROSQueueThread, this));

  // Mechanism for Updating every World Cycle
  // Listen to the update event. This event is broadcast every
  // simulation iteration.
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
     boost::bind(&Vehicle_w::UpdateStates, this));
}

////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::SetRobotModeTopic(const std_msgs::String::ConstPtr &_str)
{
  this->SetRobotMode(_str->data);
}

////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::SetRobotMode(const std::string &_str)
{
  if (_str == "no_gravity")
  {
    // stop warping robot
...
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::SetRobotCmdVel(const geometry_msgs::Twist::ConstPtr &_cmd)
{
...
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::SetRobotPose(const geometry_msgs::Pose::ConstPtr &_pose)
{
...
//void Vehicle_w::RobotGrabFireHose(const geometry_msgs::Pose::ConstPtr &/*_cmd*/)
/*{
...
*/
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::RobotReleaseLink(const geometry_msgs::Pose::ConstPtr &/*_cmd*/)
{
...
physics::JointPtr Vehicle_w::AddJoint(physics::WorldPtr _world,
...
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::RobotEnterCar(const geometry_msgs::Pose::ConstPtr &_pose)
{
...
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::RobotExitCar(const geometry_msgs::Pose::ConstPtr &_pose)
{
  // Check if drcVehicle.model is loaded
  if (!this->drcVehicle.model)
  {
...
////////////////////////////////////////////////////////////////////////////////
// remove a joint
void Vehicle_w::RemoveJoint(physics::JointPtr &_joint)
{
  bool paused = this->world->IsPaused();
  this->world->SetPaused(true);
  if (_joint)
...
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::Teleport(const physics::LinkPtr &_pinLink,
...
////////////////////////////////////////////////////////////////////////////////
/*void Vehicle_w::FireHose::Load(physics::WorldPtr _world, sdf::ElementPtr _sdf)
{
...
*/
void Vehicle_w::CheckThreadStart()
{
...
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::Vehicle::Load(physics::WorldPtr _world, sdf::ElementPtr _sdf)
{
  this->isInitialized = false;
  // load parameters
...
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::Robot::Load(physics::WorldPtr _world, sdf::ElementPtr _sdf)
{
  this->isInitialized = false;
...
void Vehicle_w::LoadVRCROSAPI()
{
  ...
  ros::SubscribeOptions robot_enter_car_so =
    ...
    boost::bind(&Vehicle_w::RobotEnterCar, this, _1),
  ...
  ros::SubscribeOptions robot_exit_car_so =
    ...
    boost::bind(&Vehicle_w::RobotExitCar, this, _1),
    ros::VoidPtr(), &this->rosQueue);
  ...
  ros::SubscribeOptions robot_grab_so =
    ...
    boost::bind(&Vehicle_w::RobotGrabFireHose, this, _1),
    ros::VoidPtr(), &this->rosQueue);
  ...
  ros::SubscribeOptions robot_release_so =
    ...
    boost::bind(&Vehicle_w::RobotReleaseLink, this, _1),
    ros::VoidPtr(), &this->rosQueue);
  this->subRobotRelease = this->rosNode->subscribe(robot_release_so);
}
*/
////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::LoadRobotROSAPI()
{
  ...
  ros::SubscribeOptions trajectory_so =
    ...
    boost::bind(&Vehicle_w::SetRobotCmdVel, this, _1),
    ros::VoidPtr(), &this->rosQueue);
  ...
  ros::SubscribeOptions pose_so =
    ros::SubscribeOptions::create<geometry_msgs::Pose>(
    pose_topic_name, 100,
    boost::bind(&Vehicle_w::SetRobotPose, this, _1),
    ros::VoidPtr(), &this->rosQueue);
  ...
  ros::SubscribeOptions configuration_so =
    ...
    boost::bind(&Vehicle_w::SetRobotConfiguration, this, _1),
    ros::VoidPtr(), &this->rosQueue);
  ...
  ros::SubscribeOptions mode_so =
    ...
    mode_topic_name, 100,
    boost::bind(&Vehicle_w::SetRobotModeTopic, this, _1),
    ros::VoidPtr(), &this->rosQueue);
  this->atlas.subMode = this->rosNode->subscribe(mode_so);
}

////////////////////////////////////////////////////////////////////////////////
void Vehicle_w::SetRobotConfiguration(const sensor_msgs::JointState::ConstPtr
  &_cmd)
{

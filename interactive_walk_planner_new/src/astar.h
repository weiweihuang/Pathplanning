...
#define STEP_LENGTH_FACTOR 1.0f
#define STEP_WIDTH_FACTOR 1.0f
...
#define MAX_Y 2.0
#define MIN_Y -2.0
#define DISTANCE 0.02f
// resolution of terrain map, X and Y distance/pixel should be equal
#define TERRAIN_N_X 200
#define TERRAIN_N_Y 200
...
typedef struct astar_node
{
  ...
  int action_index; // action used for the node

...
#define TERRAIN_N_X 100
#define TERRAIN_N_Y 100

// constants
#define BIG_COST 1e5f  // big value for cost map
...
#define STEP_LENGTH 0.7f // meters
#define HIP_WIDTH 0.178f // meters
...
// FIX THIS
#define DISTANCE 0.04f // should be WIDTH/T_MAX_N_X or HEIGHT/T_MAX_N_Y
...
extern void plan();
extern void printf_final_path( PATH_NODE *pn );
